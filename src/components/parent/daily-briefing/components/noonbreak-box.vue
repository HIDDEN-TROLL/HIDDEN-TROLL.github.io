    ...
    <div class="lunch-break">
        ...
        <div class="table-list" :style="computHeight">
            <div class="title-left">
                <span class="title" style="border: none" v-for="(value, key) in lunchBreak.comments">{{value.name}}</span>
                <!--<span class="title"  style="border: none" >时间</span>-->
                ...
                <div class="scroll-box" :style="computChildern">
                    <div class="w-box" :style="computWidth">
                        <div class="top-part">
                            ...
                            <div class="hori"  v-for="(item,value,key,index) in lunchBreak.day" >
                                <span class="linght" style="border: none;line-height: 0.15rem;margin-top: 0.05rem"  ><span >{{item.date}}</span></span>
                            </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            computWidth:{
                get(){
                    return {width:this.lunchBreak.day.width+'rem'}
                },
                set(val){
                    this.wid = val
                }
