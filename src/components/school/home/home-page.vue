...
import { ROLE_TYPE_DIRECTOR } from '@/utils/constant'
import { mapActions, mapState, mapMutations } from 'vuex'
import storeModuleRegister from '@/utils/store-module-register'
import storeModule from '@/store/modules/school/home'
...
export default {
  ...
  created() {
    ...
    // 设置当前是校长端
    this.$store.commit('UPDATE_ROLE_TYPE', ROLE_TYPE_DIRECTOR)
