                    ...
                    <div class="fam_list" >
                        <van-row>
                            <van-col span="8" style="float: left" v-for="(item2,index2) in item.stuList" :key="index2">
                                <div class="Stu_box" @click="CheckMore(item2.stuId)">
...
<script>
    import { Icon, Tab, Tabs,Actionsheet,Row, Col, Button,Toast,Switch ,NavBar} from "vant";
    import { mapState } from "vuex";
    import { changescoreClass } from '@/api/school/score-manage';
    ...
    export default {
        ...
        methods: {
            ...
            CheckMore(id){
                this.$router.push({name:'ChangeScore',
                    params:{
                       id:id
                    }
                })
