<template>
  <section class="score-content">
    ...
    <div class="echarts-wrapper">
      ...
      <div style="width:100%;overflow: scroll;">
        <div ref="mycharts2" class="charts"></div>
        <!--  :style="chartsWidth2" -->
      </div>
      <div style="padding-bottom: 0.19rem;">
...
export default {
  ...
  methods: {
    createdPage() {
      ...
      return getScoreDetails(0, this.subject, this.templateId)
        .then(res => {
          //学生详情数据处理
