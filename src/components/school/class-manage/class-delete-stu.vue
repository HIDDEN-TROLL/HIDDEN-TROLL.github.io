<template>
    <div class="detail-box">
        ...
        <div class="student">
            <p class="total">共{{DeleteList.length}}位学生</p>
            <van-list v-model="loading" :finished="finished" finished-text="没有更多了" @load="onLoad">
                <div class="list-content" v-if="student">
                    <van-checkbox-group v-model="result">
                        <van-cell-group>
                            <van-cell @click="toggle(index)" v-for="(item,index) in DeleteList" :key="index">
                                <div class="item">
                                    <div class="lt">
...
<script>
    ...
    import { DeleteClassStu } from '@/api/school/class-manage'
    ...
    export default {
        ...
        data() {
            return {
                ...
                DeleteList: this.$route.query.DeleteList,
